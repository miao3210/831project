...
class LunarLander(gym.Env, EzPickle):
    ...
    def __init__(
        ...
        ## miao use these for penalty
        self.mu_state0 = [None, 0] # x
        self.nu_state3 = [None, 0] # v_y
        self.var = 0
    ...
    def step(self, action):
        ...
        ## miao state variance penalty
        if self.mu_state0[0] is not None and self.nu_state3[0] is not None:
            self.mu_state0 = [(self.mu_state0[0] * self.mu_state0[1] + state[0])/(self.mu_state0[1]+1), self.mu_state0[1]+1]
            self.nu_state3 = [(self.nu_state3[0] * self.nu_state3[1] + state[3])/(self.nu_state3[1]+1), self.nu_state3[1]+1]
        else:
            self.mu_state0 = [state[0], 1]
            self.nu_state3 = [state[3], 1]
        self.var = (self.mu_state0[1]-1) / self.mu_state0[1] * (self.var + (state[0] - self.mu_state0[0])*(state[0] - self.mu_state0[0]) + (state[3] - self.nu_state3[0])*(state[3] - self.nu_state3[0]))
        penalty_var = -0.1 * ( self.var )
        
        ## miao velocity and x direction penalty
        ...
        if self.prev_shaping is not None:
            ...
            reward = shaping - self.prev_shaping + penalty_var + penalty_leave
        ...
        if terminated:
            # miao
            self.mu_state0 = [None, 0]
            self.nu_state3 = [None, 0]
            self.var = 0
