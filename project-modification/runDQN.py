...
model = DQN("MlpPolicy", env, verbose=1, device=1, seed=666)
callback = SaveOnBestTrainingRewardCallback(check_freq=10, log_dir=log_dir)
model.learn(total_timesteps=timesteps, callback=callback) #25000)
model.save("dqn_lunarlander-v2") #cartpole")
plot_results([log_dir], timesteps, results_plotter.X_TIMESTEPS, "DQN LunarLander")
#plt.show()
...
model = PPO.load("dqn_lunarlander-v2")
...
writer = imageio.get_writer('dqn_lunarlander-v2.mp4', fps=20)
