...
model = PPO("MlpPolicy", env, verbose=1, device=1, seed=1)
callback = SaveOnBestTrainingRewardCallback(check_freq=10, log_dir=log_dir)
model.learn(total_timesteps=timesteps, callback=callback) #25000)
model.save("ppo_lunarlander-v2-PPO") #cartpole")
...
model = PPO.load("ppo_lunarlander-v2-PPO")
...
writer = imageio.get_writer(log_dir+'PPO_lunarlander-v2.mp4', fps=20)
