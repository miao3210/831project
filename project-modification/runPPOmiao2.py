...
from stable_baselines3 import PPOmiao2 as PPO
...
parser.add_argument(
    '--log_folder_name', '-folder',
    type=str,
    default='logs-PPO2-xi',
)

parser.add_argument('--confidence_xi', type=float, default=1.0)
...
# Create log dir
log_dir = args.log_folder_name #"logs/" # this is for the basic PPO2, the one with no xi, i.e. equivalent to xi=1
timesteps = 1e6 * 16 
...
writer = imageio.get_writer('./' + args.log_folder_name +'/PPO_lunarlander-v2-cpu.mp4', fps=20) # rename later!!!!!!!
